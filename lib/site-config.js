...
export const siteConfig = {
  ...
  shortName: "PCS Pal",
  description:
    "PCS Pal helps military service members and families plan Permanent Change of Station moves with PCS checklists, inventory tracking, logistics planning, and destination base research.",
...
export const primaryPublicNavLinks = [
  { href: "/", label: "Home", key: "home" },
  {
    ...
    label: "PCS Checklist",
    key: "pcs-checklist-guide",
  },
  {
    href: "/how-to-plan-a-military-pcs-move",
    label: "Planning Guide",
    key: "pcs-planning-guide",
  },
  {
    href: "/bases",
    label: "Base Research",
...
export const publicResourceLinks = [
  ...
  {
    href: "/how-to-plan-a-military-pcs-move",
    label: "How to Plan a Military PCS Move",
  },
  {
    href: "/bases",
    label: "Military Destination Base Research",
  },
];
