export const FEEDBACK_SOURCE = "web";
...
export const FEEDBACK_STATUS_LABELS = Object.fromEntries(
  FEEDBACK_STATUS_OPTIONS.map((option) => [option.value, option.label])
);
...
export const formatFeedbackStatusLabel = (value) => FEEDBACK_STATUS_LABELS[value] || "Unknown";
